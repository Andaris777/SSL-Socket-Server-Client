...
class SocketClient:
    ...
    def send_message(self):
        ...
        try:
            ...
            context.load_verify_locations(str(os.path.join((os.path.dirname(os.path.abspath(__name__))),
            ...
            self.securesocket = context.wrap_socket(self.socket)
        ...
        try:
            ...
            if ActualTime > NotAfter:
                raise Exception("Server client certificate")
